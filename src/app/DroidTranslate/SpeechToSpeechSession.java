...
public class SpeechToSpeechSession extends Activity implements View.OnClickListener, OnInitListener {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == VOICE_RECOGNITION_REQUEST_CODE && resultCode == RESULT_OK) {
			...
			from = LanguageValidator.getLanguageString(LanguageValidator.ENGLISH_LANG);
			try {
				// Call API function to translate text
				translatedText = LanguageValidator.translateString(from, to, lblFrom.getText().toString());
